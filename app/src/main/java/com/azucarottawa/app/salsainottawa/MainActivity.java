...
import com.azucarottawa.app.salsainottawa.core.Event;
import com.azucarottawa.app.salsainottawa.server.QueryClient;
import com.azucarottawa.app.salsainottawa.server.ServerConnection;
import com.azucarottawa.app.salsainottawa.utils.AppUtils;
import com.azucarottawa.app.salsainottawa.utils.Constants;
import com.azucarottawa.app.salsainottawa.utils.DateUtils;
...
public class MainActivity extends ActionBarActivity implements QueryClient {
    ...
    private TextView iInfoText;
    private LinearLayout iInfoLayout;
    ...
    public void initializeViewComponents() {
        ...
        iInfoText = (TextView) findViewById(R.id.info_text);
        iInfoLayout = (LinearLayout) findViewById(R.id.info_layout);
    }
    ...
    public void decorateComponents() {
        ...
        iInfoText.setTypeface(customFont);
    }
    ...
    public void activateActionListeners() {
        ...
        iInfoLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onInfoLayoutPressed();
            }
    ...
    public void deactivateActionListeners() {
        ...
        iInfoLayout.setOnClickListener(null);
    }
    ...
    /**
     * On click listener for app info layout.
     */
    public void onInfoLayoutPressed() {
